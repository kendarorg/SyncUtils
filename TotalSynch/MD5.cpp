 ...
 * \brief Constructor for files
 *
 * \param file			IN, Input File Pointer
 * \param file_length	IN, Input File Lenght to control
 *
 **/

MD5::MD5(char* file_buffer, unsigned int file_length)
{

     init();
// 	unsigned char* tmp = (unsigned char*) file_buffer;
// 	while(tmp < (unsigned char*)(file_buffer + file_length)){
// 		update(tmp,1024);
// 		tmp+= 1024;
// 	}
     update((unsigned char*)file_buffer,file_length);
     finalize ();
}
 ...
 * \version 1.0.0
 *
 * \fn void MD5::update (uint1 *input, uint4 input_length)
 * \brief MD5 block update operation. Continues an MD5 message-digest
 *		operation, processing another message block, and updating the
 *		context.
 *
 * \param input IN, Input Stream Buffer
 * \param input_length IN, Length of the input buffer in bytes
 *
 **/
 ...
 * \version 1.0.0
 *
 * \fn void MD5::update(FILE *file)
 * \brief MD5 update for files.
...
//  *
//  *
// void MD5::update(FILE *file, unsigned int file_length){
//
//   unsigned char buffer[1024];
//   int len;
//   unsigned int tot_len = 0;
//
//   while ((len=fread(buffer, 1, 1024, file)) || (tot_len!=file_length)){
//
// 	  tot_len +=len;
// 	  update(buffer, len);
//   }
...
int MD5::raw_digest(unsigned char* result)
{
...
/**
 * Liberare la memoria dopo l'uso!!!!!!!
 */
char *MD5::hex_digest()
{
